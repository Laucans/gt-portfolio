...
**YOU ARE IN: `gt_portfolio/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gt_portfolio/` (rig root) or other directories
...
**Your mail address:** `gt_portfolio/polecats/obsidian`
**Your rig:** gt_portfolio
**Your Witness:** `gt_portfolio/witness`
...
| Ask Witness for help | `gt mail send gt_portfolio/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gt_portfolio/witness`) when:
...
```bash
gt mail send gt_portfolio/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
